...
session_start();
if(!isset($_SESSION["login"]) || ($_SESSION["acesso"] != 'AUX' ) )
{
...
<div class="navbar navbar-inverse navbar">
 ...
 <form class="form-inline" role="form"   method="POST" action="auxi.php" style="margin-left:10%;">
 ...
 $(document).ready(function(){
  ...
  date_input.datepicker({
   ...
   autoclose: true,
    ...
    <button type="submit"  name="submit" id="submit" class="btn btn-default">Busca</button> <br><li class="active"><a href="#" id="test" onClick="javascript:fnExcelReport();" >Gerar excel</a></li><br><br><br><br><br><br><br>
  </form>
...
$sql = mysql_query ("select * from auxiliar where data BETWEEN   '$data' and '$data2' " );
...
<td> <a href="form.php?cod=<?php echo $cod ?>"> RELATORIO</a> </td>
